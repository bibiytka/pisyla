...
<body>
    <div class="container">
        ...
        ">
            <p style="margin: 0;">
                При поиске по запросу (например, «грузчик») в выдачу могут попадать смежные позиции — «комплектовщик», «сборщик», «разнорабочий» и др. Это связано с тем, что в описаниях вакансий часто пересекаются обязанности и требования: от грузчика могут ждать навыков комплектовки, а от комплектовщика — физической выносливости. Поэтому даже при несовпадении названия вакансия может быть релевантна запросу.<br>
                Если вы хотите исключить такие совпадения — включите <strong>«Фильтр по суффиксам»</strong> (находится над кнопкой «Найти вакансии»).
            </p>
        </div>
